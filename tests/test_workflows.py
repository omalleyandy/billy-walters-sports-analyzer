...
class TestWorkflows:
    ...
    @pytest.mark.skipif(sys.platform != "win32", reason="PowerShell script (Windows only)")
...
class TestEndToEnd:
    ...
    def test_analyze_game_end_to_end(self):
        ...
        result = subprocess.run(
            [
                sys.executable, "-m", "walters_analyzer.cli",
                "analyze-game",
...
class TestSystemHealth:
    ...
    def test_imports_work(self):
        ...
        from walters_analyzer.ingest.chrome_devtools_ai_scraper import EnhancedChromeDevToolsOddsExtractor
    ...
    def test_core_modules_available(self):
        ...
        import walters_analyzer.core.analyzer
        import walters_analyzer.core.bankroll
        import walters_analyzer.core.calculator
        import walters_analyzer.core.models
        import walters_analyzer.core.point_analyzer
        
        assert True
    
    def test_research_modules_available(self):
        """Test all research modules are importable"""
        import walters_analyzer.research.engine
        import walters_analyzer.research.accuweather_client
        import walters_analyzer.research.profootballdoc_fetcher
