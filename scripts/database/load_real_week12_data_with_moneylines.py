...
def insert_real_week12_games(db):
    ...
    games = [
        ("KC_TB_2025_W12", 2025, 12, "NFL", "2025-11-20 20:20:00", "Tampa Bay Buccaneers", "Kansas City Chiefs", "Raymond James Stadium", True),
        ("BUF_KC_2025_W12", 2025, 12, "NFL", "2025-11-23 13:00:00", "Kansas City Chiefs", "Buffalo Bills", "Arrowhead Stadium", True),
        ("SF_GB_2025_W12", 2025, 12, "NFL", "2025-11-23 13:00:00", "Green Bay Packers", "San Francisco 49ers", "Lambeau Field", True),
        ("PHI_BAL_2025_W12", 2025, 12, "NFL", "2025-11-23 13:00:00", "Baltimore Ravens", "Philadelphia Eagles", "M&T Bank Stadium", True),
        ("TEN_NE_2025_W12", 2025, 12, "NFL", "2025-11-23 13:00:00", "New England Patriots", "Tennessee Titans", "Gillette Stadium", True),
        ("LAC_ARI_2025_W12", 2025, 12, "NFL", "2025-11-23 16:05:00", "Arizona Cardinals", "Los Angeles Chargers", "State Farm Stadium", True),
        ("LV_LAR_2025_W12", 2025, 12, "NFL", "2025-11-23 16:05:00", "Los Angeles Rams", "Las Vegas Raiders", "SoFi Stadium", True),
        ("WAS_NOG_2025_W12", 2025, 12, "NFL", "2025-11-23 16:05:00", "New Orleans Saints", "Washington Commanders", "Caesars Superdome", False),
        ("MIA_NYJ_2025_W12", 2025, 12, "NFL", "2025-11-23 20:20:00", "New York Jets", "Miami Dolphins", "MetLife Stadium", True),
        ("SEA_MIN_2025_W12", 2025, 12, "NFL", "2025-11-24 20:15:00", "Minnesota Vikings", "Seattle Seahawks", "U.S. Bank Stadium", False),
        ("DET_CHI_2025_W12", 2025, 12, "NFL", "2025-11-27 12:30:00", "Detroit Lions", "Chicago Bears", "Ford Field", False),
        ("DAL_NYG_2025_W12", 2025, 12, "NFL", "2025-11-27 16:30:00", "Dallas Cowboys", "New York Giants", "AT&T Stadium", True),
        ("IND_NE_2025_W12", 2025, 12, "NFL", "2025-11-27 20:20:00", "New England Patriots", "Indianapolis Colts", "Gillette Stadium", True),
    ]

    for game_id, season, week, league, game_date, home_team, away_team, stadium, is_outdoor in games:
        db.execute_query(
            """
            INSERT INTO games
            ...
            """,
            (game_id, season, week, league, game_date, home_team, away_team, stadium, is_outdoor, "SCHEDULED"),
            fetch=False,
        )
...
def insert_massey_power_ratings(db):
    ...
    for team, season, week, league, rating in ratings:
        db.execute_query(
            ...
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, NOW(), NOW())
            """,
            (season, week, league, team, rating, "composite", rating, rating + 1.5, rating - 1.5, rating - 3.0),
            fetch=False,
        )
...
def insert_realistic_odds_with_moneylines(db):
    ...
    for game_id, sportsbook, odds_type, spread, juice, total, total_juice in odds_data:
        ...
        db.execute_query(
            ...
            """,
            (
                game_id, sportsbook, odds_type, spread, juice, -spread, juice,
                total, total_juice, total_juice, home_ml, away_ml,
            ),
            fetch=False,
        )
...
def insert_structure_for_analysis(db):
    ...
    for game_id, team, days_rest, is_short, is_extra, travel, tz_change, is_long, is_div, is_rivalry, is_revenge, is_prime in key_games:
        db.execute_query(
            """
            ...
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, NOW(), NOW())
            """,
            (game_id, team, days_rest, is_short, is_extra, travel, tz_change, is_long, is_div, is_rivalry, is_revenge, is_prime),
            fetch=False,
        )
    ...
    for game_id, temp, feels_like, wind, gust, direction, humidity, precip_chance, precip_type, precip_amt, vis, cloud, category, total_adj, spread_adj in weather_data:
        if temp is not None:
            db.execute_query(
                ...
                """,
                (game_id, temp, feels_like, wind, gust, direction, humidity, precip_chance, precip_type, vis, cloud, category, total_adj, spread_adj, 20, "accuweather", "forecast", False),
                fetch=False,
            )
