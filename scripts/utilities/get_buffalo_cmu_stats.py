...
try:
    ...
    print(
        f"Total Yards/Game:         {buf_metrics.get('total_yards_per_game', 'N/A'):.1f}"
    )
    print(
        f"Passing Yards/Game:       {buf_metrics.get('passing_yards_per_game', 'N/A'):.1f}"
    )
    print(
        f"Rushing Yards/Game:       {buf_metrics.get('rushing_yards_per_game', 'N/A'):.1f}"
    )
    print(
        f"Points Allowed/Game:      {buf_metrics.get('points_allowed_per_game', 'N/A'):.1f}"
    )
    print(
        f"Yards Allowed/Game:       {buf_metrics.get('total_yards_allowed_per_game', 'N/A'):.1f}"
    )
...
try:
    ...
    print(
        f"Total Yards/Game:         {cmu_metrics.get('total_yards_per_game', 'N/A'):.1f}"
    )
    print(
        f"Passing Yards/Game:       {cmu_metrics.get('passing_yards_per_game', 'N/A'):.1f}"
    )
    print(
        f"Rushing Yards/Game:       {cmu_metrics.get('rushing_yards_per_game', 'N/A'):.1f}"
    )
    print(
        f"Points Allowed/Game:      {cmu_metrics.get('points_allowed_per_game', 'N/A'):.1f}"
    )
    print(
        f"Yards Allowed/Game:       {cmu_metrics.get('total_yards_allowed_per_game', 'N/A'):.1f}"
    )
...
if buf_success and cmu_success:
    ...
    print("Market Spread: Buffalo +2.0")
    ...
    print(
        f"  Turnover Margin: Buffalo {buf_metrics['turnover_margin']:+.0f} vs CMU {cmu_metrics['turnover_margin']:+.0f}"
    )
else:
