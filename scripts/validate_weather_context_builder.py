...
try:
    ...
    print(f"  python scripts/validate_weather_context_builder.py")
    sys.exit(1)
...
class WeatherBuilderValidator:
    ...
    def validate_warm_teams(self):
        ...
        try:
            ...
            for team in list(WARM_WEATHER_TEAMS)[:3]:  # Test first 3
                ...
                if suit in [TeamWeatherSuitability.UNFAVORABLE, TeamWeatherSuitability.HIGHLY_UNFAVORABLE]:
                    unfavorable_count += 1
    ...
    def validate_cold_teams(self):
        ...
        try:
            ...
            self.test(
                "Buffalo Bills favorable in cold",
                is_good,
