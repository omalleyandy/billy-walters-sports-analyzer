...
class HighlightlyClient:
    ...
    def __init__(self, api_key: Optional[str] = None, use_rapidapi: bool = False):
        ...
        self.api_key = (
            api_key or 
            os.getenv("HIGHLIGHTLY_API_KEY") or
            getattr(self.settings, 'highlightly_api_key', None)
        )
    ...
    async def get_highlight_by_id(self, highlight_id: int) -> Optional[HighlightlyHighlight]:
        """
        Get highlight by ID
