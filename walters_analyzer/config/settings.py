...
class MarketAnalysisConfig(BaseModel):
    ...
    enabled: bool = True
    sharp_books: List[str] = Field(default_factory=lambda: ["Pinnacle", "Circa", "Bookmaker"])
    public_books: List[str] = Field(default_factory=lambda: ["DraftKings", "FanDuel", "BetMGM"])
...
class SituationalDatabaseConfig(BaseModel):
    ...
    enabled: bool = True
    track_situations: List[str] = Field(default_factory=lambda: [
        "sandwich_spot",
        "lookahead_game",
        "revenge_game",
        "division_rivalry",
...
class SkillsConfig(BaseModel):
    ...
    situational_database: SituationalDatabaseConfig = Field(default_factory=SituationalDatabaseConfig)
...
class Settings(BaseSettings):
    ...
    ov_customer_password: Optional[str] = Field(default=None, alias='OV_CUSTOMER_PASSWORD')
    ...
    highlightly_api_key: Optional[str] = Field(default=None, alias='HIGHLIGHTLY_API_KEY')
    accuweather_api_key: Optional[str] = Field(default=None, alias='ACCUWEATHER_API_KEY')
    ...
    # Autonomous agent
    autonomous_agent: AutonomousAgentConfig = Field(default_factory=AutonomousAgentConfig)

    # Data connections
    data_connections: DataConnectionsConfig = Field(default_factory=DataConnectionsConfig)
