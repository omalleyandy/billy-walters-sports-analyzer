...
try:
    ...
    print(
        f"Total Yards/Game:         {niu_metrics.get('total_yards_per_game', 'N/A'):.1f}"
    )
    print(
        f"Passing Yards/Game:       {niu_metrics.get('passing_yards_per_game', 'N/A'):.1f}"
    )
    print(
        f"Rushing Yards/Game:       {niu_metrics.get('rushing_yards_per_game', 'N/A'):.1f}"
    )
    print(
        f"Points Allowed/Game:      {niu_metrics.get('points_allowed_per_game', 'N/A'):.1f}"
    )
    print(
        f"Yards Allowed/Game:       {niu_metrics.get('total_yards_allowed_per_game', 'N/A'):.1f}"
    )
...
try:
    ...
    print("=" * 70)
    print(
        f"Points Per Game:          {umass_metrics.get('points_per_game', 'N/A'):.1f}"
    )
    print(
        f"Total Yards/Game:         {umass_metrics.get('total_yards_per_game', 'N/A'):.1f}"
    )
    print(
        f"Passing Yards/Game:       {umass_metrics.get('passing_yards_per_game', 'N/A'):.1f}"
    )
    print(
        f"Rushing Yards/Game:       {umass_metrics.get('rushing_yards_per_game', 'N/A'):.1f}"
    )
    print(
        f"Points Allowed/Game:      {umass_metrics.get('points_allowed_per_game', 'N/A'):.1f}"
    )
    print(
        f"Yards Allowed/Game:       {umass_metrics.get('total_yards_allowed_per_game', 'N/A'):.1f}"
    )
    print(
        f"Turnover Margin:          {umass_metrics.get('turnover_margin', 'N/A'):+.0f}"
    )
    print(
        f"Third Down %:             {umass_metrics.get('third_down_pct', 'N/A'):.1f}%"
    )
