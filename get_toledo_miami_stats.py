...
try:
    ...
    print(f"Total Yards/Game:         {tol_metrics.get('total_yards_per_game', 'N/A'):.1f}")
    print(f"Passing Yards/Game:       {tol_metrics.get('passing_yards_per_game', 'N/A'):.1f}")
    print(f"Rushing Yards/Game:       {tol_metrics.get('rushing_yards_per_game', 'N/A'):.1f}")
    print(f"Points Allowed/Game:      {tol_metrics.get('points_allowed_per_game', 'N/A'):.1f}")
    print(f"Yards Allowed/Game:       {tol_metrics.get('total_yards_allowed_per_game', 'N/A'):.1f}")
...
try:
    ...
    print(f"Total Yards/Game:         {moh_metrics.get('total_yards_per_game', 'N/A'):.1f}")
    print(f"Passing Yards/Game:       {moh_metrics.get('passing_yards_per_game', 'N/A'):.1f}")
    print(f"Rushing Yards/Game:       {moh_metrics.get('rushing_yards_per_game', 'N/A'):.1f}")
    print(f"Points Allowed/Game:      {moh_metrics.get('points_allowed_per_game', 'N/A'):.1f}")
    print(f"Yards Allowed/Game:       {moh_metrics.get('total_yards_allowed_per_game', 'N/A'):.1f}")
...
if tol_success and moh_success:
    ...
    print(f"\nOffense vs Defense:")
    print(f"  Toledo Offense ({tol_ppg:.1f} PPG) vs Miami Defense ({moh_papg:.1f} PA/G)")
    print(f"  Miami Offense ({moh_ppg:.1f} PPG) vs Toledo Defense ({tol_papg:.1f} PA/G)")
    ...
    print(f"Weather Adjustment: -3.0 points (16 mph wind, 30 mph gusts)")
    print(f"Weather-Adjusted Total: {predicted_total - 3.0:.1f}")
    print(f"Market Total: 44.0")
    ...
    print(f"Market Spread: Toledo -5.5")
    ...
    print(f"  Turnover Margin: Toledo {tol_metrics['turnover_margin']:+.0f} vs Miami {moh_metrics['turnover_margin']:+.0f}")
else:
